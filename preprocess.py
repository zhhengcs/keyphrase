...
opt.train_path = 'data/small/train_18k.json'
opt.test_path = 'data/small/test_2k.json'
...
def main():
    ...
    # json_save(valid_one2one, open(opt.save_data + '.valid.one2one.pt', 'wb'))
    # json_save(valid_one2many, open(opt.save_data + '.valid.one2many.pt', 'wb'))
    # return
    '''
